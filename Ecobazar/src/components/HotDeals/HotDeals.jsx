...
import HotDealsCart from '../hotdealscart/HotDealsCart'
...
function HotDeals() {
  return (
    <Container>
        ...
        <div>
          <HomeHeader homeheader="Hot Deals"/>
        </div>
        ...
        <div className='md:flex md:flex-row flex-col   gap-1'>
            ...
            <div className="grid md:grid-cols-3 grid-cols-1 gap-6 md:mt-0 mt-9">
        ...
        <div className="md:grid md:grid-cols-5 grid-cols-1 gap-6 mt-6">
              {allProducts.slice(6,11).map((item) => (
                <div
                  key={item.id}
                  className={`relative border  border-zinc-300 hover:border-zinc-500 hover:shadow-lg rounded-md p-4 gap-3 md:mb-0 mb-3 group transition-all
                  ${item.featured ? "border-green-500" : "border-gray-200"}`}
